...
print '<input class="formstyle" type="number" size="35" name="temp" required/><br />';
print '<input class="formstyle" type="number" size="35" name="rh" required/><br />';
...
print '</select><br />';
print '<input class="formstyle" type="number" size="35" name="par" /><br />';
